...
# ENV defaults
# NOTE: PGRST_JWT_SECRET below is a placeholder default carried over from the
# base CE Dockerfile. The deploy workflow overrides it via Render envVars. As
# part of the secrets-rotation work, move this to a GitHub secret with a fresh
